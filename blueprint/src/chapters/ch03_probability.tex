...
$\omega$ \cite[\S2.6]{boucheron2013concentration}.
\end{defn}
...
\cite[\S11]{kallenberg}, \cite[Ch.~12]{boucheron2013concentration}.
\end{defn}
...
\cite{vapnik1971}, \cite[Ch.~12]{boucheron2013concentration}.
\end{defn}
...
\cite[\S4.1]{boucheron2013concentration}.
\end{thm}
...
by a factor of $2$
\cite[\S4.1]{boucheron2013concentration}, \cite[Ch.~1]{villani2009}.
\end{defn}

\begin{thm}[Non-negativity of $\mathrm{tvDistance}$]
\label{thm:tv-distance-nonneg}
  \lean{ProbabilityTheory.FintypePMF.tvDistance\_nonneg}
  \leanok
  \uses{def:tv-distance-fintype}
$\mathrm{tvDistance}(p, q) \ge 0$
\cite[\S4.1]{boucheron2013concentration}.
\end{thm}

\begin{thm}[Symmetry of $\mathrm{tvDistance}$]
\label{thm:tv-distance-comm}
  \lean{ProbabilityTheory.FintypePMF.tvDistance\_comm}
  \leanok
  \uses{def:tv-distance-fintype}
$\mathrm{tvDistance}(p, q) = \mathrm{tvDistance}(q, p)$
\cite[\S4.1]{boucheron2013concentration}.
\end{thm}

\begin{thm}[Self-distance is zero]
\label{thm:tv-distance-self}
  \lean{ProbabilityTheory.FintypePMF.tvDistance\_self}
  \leanok
  \uses{def:tv-distance-fintype}
$\mathrm{tvDistance}(p, p) = 0$
\cite[\S4.1]{boucheron2013concentration}.
\end{thm}
