...
Proof route: indicator random variables, Popoviciu's variance bound,
independence for variance of a sum, then Chebyshev's inequality.
...
hold is `≥ 1 - δ`. -/
lemma ProbabilityTheory.chebyshev_majority_bound
